export default {
    fetchProjects: () => new Promise( (resolve, reject) => resolve( [
        ...
        },
        {
            ...
            links: [ {url: "https://github.com/PierfrancescoSoffritti/RemoteVR_UnityServer", name: "Go to the Unity Server", icon: "fab fa-github"}, {url: "https://github.com/PierfrancescoSoffritti/RemoteVR_AndroidClient", name:"Go to the Android Client", icon: "fab fa-github"} ],
            secondaryLinks: [ ],
        ...
        },
        {
            ...
            links: [ {url: "https://pierfrancescosoffritti.github.io/Nowherelands/", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://www.youtube.com/watch?v=kuLsG6gpzAM", name: "Watch the video", icon: "fab fa-youtube"}, {url: "https://github.com/PierfrancescoSoffritti/Doodling/tree/master/13.%20Nowherelands", name: "Go to the code", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "https://rawgit.com/PierfrancescoSoffritti/Doodling/master/10.%20BrokenMantra/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/Doodling/tree/master/10.%20BrokenMantra", name: "Go to the code", icon: "fab fa-github"} ],
            secondaryLinks: [ ],
            labels: [ "web", "experiment" ],
        ...
        },
        {
            ...
            links: [ {url: "https://rawgit.com/PierfrancescoSoffritti/Doodling/master/12.%20Collatz%20Conjecture/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/Doodling/tree/master/12.%20Collatz%20Conjecture", name: "Go to the code", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "https://rawgit.com/PierfrancescoSoffritti/Doodling/master/4.%20SoUNds/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/Doodling/tree/master/4.%20SoUNds", name: "Go to the code", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "https://rawgit.com/PierfrancescoSoffritti/Doodling/master/9.%20EyeBall/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/Doodling/tree/master/9.%20EyeBall", name: "Go to the code", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "https://rawgit.com/PierfrancescoSoffritti/Doodling/master/6.%20NeonCrystal/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/Doodling/tree/master/6.%20NeonCrystal", name: "Go to the code", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "https://github.com/PierfrancescoSoffritti/HeightMapGenerator", name: "Go to the code", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "https://rawgit.com/PierfrancescoSoffritti/TerrainGenerator/master/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/TerrainGenerator", name: "Go to the code", icon: "fab fa-github"} ],
            secondaryLinks: [ ],
            labels: [ "web", "experiment" ],
        ...
        },
        {
            ...
            links: [ {url: "https://github.com/PierfrancescoSoffritti/EyeSwapper", name: "Go to the code", icon: "fab fa-github"} ],
            secondaryLinks: [ ],
            labels: [ "android" ],
        ...
        },
        {
            ...
            links: [ {url: "https://github.com/PierfrancescoSoffritti/SlidingDrawer", name: "Go to the code", icon: "fab fa-github"} ],
            secondaryLinks: [ ],
        ...
        },
        {
            ...
            links: [ {url: "https://github.com/PierfrancescoSoffritti/AndroidYouTubePlayer", name: "Go to the code", icon: "fab fa-github"} ],
            secondaryLinks: [ ],
            labels: [ "android", "library" ],
        ...
        },
        {
            ...
            links: [ {url: "https://github.com/PierfrancescoSoffritti/GoogleWebOAuth", name: "Go to the code", icon: "fab fa-github"} ],
            secondaryLinks: [ ],
            labels: [ "android", "library" ],
