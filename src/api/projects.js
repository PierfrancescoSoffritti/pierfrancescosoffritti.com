export default {
    fetchProjects: () => new Promise( (resolve, reject) => resolve( [
        ...
        },
        {
            ...
            links: [ {url: "http://pierfrancescosoffritti.github.io/doodles/13_Nowherelands/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://www.youtube.com/watch?v=kuLsG6gpzAM", name: "Watch video", icon: "fab fa-youtube"}, {url: "https://github.com/PierfrancescoSoffritti/doodles/tree/master/13_Nowherelands", name: "Open project", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "http://pierfrancescosoffritti.github.io/doodles/18_Monolith/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://www.youtube.com/watch?v=iST1-DvLhmg&t=0s&list=PLHqL12VZyHuMKFrKsthIEcoWLHInj9WSd&index=7", name: "Watch video", icon: "fab fa-youtube"}, {url: "https://github.com/PierfrancescoSoffritti/doodles/tree/master/18_Monolith", name: "Open project", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "http://pierfrancescosoffritti.github.io/doodles/10_BrokenMantra/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/doodles/tree/master/10_BrokenMantra", name: "Open project", icon: "fab fa-github"} ],
            secondaryLinks: [ ],
            labels: [ "web", "experiment" ],
        ...
        },
        {
            ...
            links: [ {url: "http://pierfrancescosoffritti.github.io/doodles/12_CollatzConjecture/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/doodles/tree/master/12_CollatzConjecture", name: "Open project", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "http://pierfrancescosoffritti.github.io/doodles/04_SoUNds/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/doodles/tree/master/04_SoUNds", name: "Open project", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "http://pierfrancescosoffritti.github.io/doodles/09_EyeBall/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/doodles/tree/master/09_EyeBall", name: "Open project", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "http://pierfrancescosoffritti.github.io/doodles/06_NeonCrystal/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"}, {url: "https://github.com/PierfrancescoSoffritti/doodles/tree/master/06_NeonCrystal", name: "Open project", icon: "fab fa-github"} ],
        ...
        },
        {
            ...
            links: [ {url: "http://pierfrancescosoffritti.github.io/doodles/03_WTPlayer/index.html", name: "Open the experiment", icon: "fas fa-external-link-alt"} ],
            secondaryLinks: [ ],
            labels: [ "web", "experiment" ],
