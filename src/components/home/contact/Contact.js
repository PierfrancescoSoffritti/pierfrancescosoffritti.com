        ...
        return (
            <div className="home-section contact-container">
                <div>
                    ...
                    <br/>or if you want to dicuss <a href="https://en.wikipedia.org/wiki/Phrases_from_The_Hitchhiker%27s_Guide_to_the_Galaxy#Answer_to_the_Ultimate_Question_of_Life.2C_the_Universe.2C_and_Everything_.2842.29" target="blank">the Ultimate Question of Life, the Universe and Everything</a> ( .. even though we all know the answer already )
                </div>
