    ...
    return (
        <div className="home-section container-about">        
            ...
            <div className="about-text">
                <span className="about-text-main">Hello! I'm <span className="about-name">Pier</span></span>
                <br/><span className="about-text-subtitle">I'm a software engineer from Italy</span>
