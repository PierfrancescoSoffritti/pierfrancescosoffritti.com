    ...
    return (
        <div className="home-section container-about">        
            ...
            <div className="about-text">
                ...
                <br/><br/>If you want to know more: <a onClick={onLinkClick} href="https://docs.google.com/document/d/1fAmPU_8BsL2XIksU9V86YQ7ea3YRO7_Da1s5N555XIU/edit?usp=sharing" target="blank"><span className="about-cv">HERE is my CV.</span></a>
